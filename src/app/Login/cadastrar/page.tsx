...
const fields = [
  ...
  { id: 'email', label: 'Email', type: 'email', placeholder: 'exemplo@gmail.com' },
  { id: 'telefone', label: 'Telefone', type: 'text', placeholder: '(99) 99999-9999' },
  { id: 'cpf', label: 'CPF', type: 'text', placeholder: '000.000.000-00' },
  { id: 'senha', label: 'Senha', type: 'password', placeholder: 'Digite sua senha' },
  { id: 'confirmaSenha', label: 'Confirme sua senha', type: 'password', placeholder: 'Confirme sua senha' },
];
