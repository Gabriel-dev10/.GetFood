...
const TermosUsoModal: React.FC<TermosUsoModalProps> = ({
  ...
  return (
    <motion.div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm w-full h-full min-h-screen overflow-hidden px-2"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      onClick={onClose}
    ...
    >
      <motion.div
        className="relative bg-gradient-to-br from-[#2a2e38] to-[#1f2229] text-white rounded-3xl shadow-2xl w-full max-w-lg min-w-[320px] flex flex-col mx-auto border border-white/5 overflow-hidden max-h-[90vh] mx-2"
      ...
      >
        <div className="relative px-4 sm:px-6 pt-6 sm:pt-8 pb-4 sm:pb-6 border-b border-white/10">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center bg-emerald-500/20 rounded-xl">
              <FileSignature className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-400" />
            </div>
            <div>
              <h2
                id="termos-modal-title"
                className="text-lg sm:text-2xl font-bold tracking-tight text-white pr-8"
              >
                Termos de Uso
              </h2>
        ...
        <div className="flex-1 px-2 sm:px-6 py-3 sm:py-6 overflow-y-auto overflow-x-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent hover:scrollbar-thumb-white/20">
          <div className="space-y-6">
            <section>
              <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                Bem-vindo ao{" "}
                <span className="font-semibold text-white">.GetFood</span> e{" "}
                <span className="font-semibold text-white">GBC Coffee</span>! Ao
                utilizar nosso aplicativo e serviços, você concorda com os
                seguintes termos e condições. Leia atentamente antes de
                continuar.
              </p>
            </section>
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <p className="text-sm sm:text-base text-gray-300">
                Ao criar uma conta ou utilizar qualquer funcionalidade do
                aplicativo, você declara ter lido, compreendido e aceito estes
                Termos de Uso e nossa Política de Privacidade. Se você não
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <ul className="space-y-2 text-sm sm:text-base text-gray-300 list-disc list-inside">
                <li>
                  Você deve fornecer informações verdadeiras, precisas e
                  atualizadas
                </li>
                <li>
                  É sua responsabilidade manter a confidencialidade da senha
                </li>
                <li>
                ...
                <li>
                  Não é permitido criar múltiplas contas para a mesma pessoa
                </li>
                <li>
                  Contas podem ser suspensas ou encerradas em caso de violação
                </li>
              </ul>
            </section>
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <div className="space-y-2 text-sm sm:text-base text-gray-300">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    Usar o serviço apenas para finalidades legais e autorizadas
                  </li>
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <div className="space-y-2 text-sm sm:text-base text-gray-300">
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>
                    Você deve pagar pelo pedido antes ou no momento da
                    entrega/retirada
                  </li>
                  <li>
                    Aceitamos as formas de pagamento descritas no aplicativo
                  </li>
                  <li>
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-white">
                  5. Programa de Pontos e Recompensas
                </h3>
              </div>
              <ul className="space-y-2 text-sm sm:text-base text-gray-300 list-disc list-inside">
                ...
                <li>
                  Reservamos o direito de modificar ou encerrar o programa
                </li>
                <li>
                  Uso indevido pode resultar em perda de pontos e suspensão
                </li>
              </ul>
            </section>
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <p className="text-sm sm:text-base text-gray-300">
                ...
                logos, ícones, imagens e software, é propriedade do .GetFood e
                GBC Coffee ou de seus licenciadores, protegido pelas leis de
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <div className="space-y-2 text-sm sm:text-base text-gray-300">
                <p>
                  O serviço é fornecido &ldquo;como está&rdquo;. Não nos
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <p className="text-sm sm:text-base text-gray-300">
                ...
                configurações. Podemos suspender ou encerrar sua conta
                imediatamente, sem aviso prévio, em caso de violação destes
                termos ou atividades suspeitas.
              </p>
            </section>
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <p className="text-sm sm:text-base text-gray-300">
                ...
                Maricá - RJ, com exclusão de qualquer outro, por mais
            ...
            <section className="bg-gradient-to-r from-emerald-500/10 to-blue-500/10 rounded-xl p-4 sm:p-5 border border-emerald-500/20">
              ...
              <p className="text-sm sm:text-base text-gray-300">
                Entre em contato conosco através da aba &ldquo;Sobre&rdquo; nas
                Informações do aplicativo ou visite-nos pessoalmente no GBC
                Coffee, Av. Roberto Silveira, 2082 - Flamengo, Maricá - RJ.
              </p>
            </section>
          </div>
        </div>
