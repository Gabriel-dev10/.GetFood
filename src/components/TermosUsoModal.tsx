...
import { FileSignature, User, BadgeCheck, CreditCard, Gift, Ban, Users, Info, Gavel, X, BookOpen } from "lucide-react";
          ...
          <div className="space-y-6">
            ...
            <section className="bg-white/5 rounded-xl p-4 sm:p-5">
              ...
              <p className="text-sm sm:text-base text-gray-300">
                Ao criar uma conta ou utilizar qualquer funcionalidade do aplicativo, você declara ter lido, compreendido
